...
export default defineConfig({
	...
	server: {
		...
		// Local-only stand-in for the /hcgi/* routing Hostinger's platform provides in
		// production and inside the Horizons preview. Not used by `vite build`/`vite preview`.
		proxy: {
			'/hcgi/api': {
