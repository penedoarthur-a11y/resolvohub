                ...
                <div className="relative mx-auto grid max-w-md gap-6 px-5 py-20">
                    ...
                    >
                        ...
                        <div className="grid gap-2">
                            ...
                            <input id="senha" type="password" required value={password} onChange={(e) => setPassword(e.target.value)} className="rounded-xl border border-white/15 bg-white/5 px-4 py-3 text-sm outline-none transition-colors focus:border-[hsl(var(--primary))] focus:bg-white/[0.07]" />
                        </div>
